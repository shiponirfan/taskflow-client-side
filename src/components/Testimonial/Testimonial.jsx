    ...
    <section className="py-12  bg-gray-50 sm:py-16 lg:py-20">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          ...
          <div className="relative mt-10 lg:mt-24 md:order-2">
              ...
              <div data-aos="flip-left" data-aos-delay="100" data-aos-duration="1000" className="flex flex-col overflow-hidden shadow-xl">
                <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                  <div className="flex-1">
                    ...
                    <blockquote className="flex-1 my-5">
                      <p className="text-lg leading-relaxed text-gray-900">
                        “Working with TaskFlow was a pleasure.
                        Their attention to detail and professionalism made our
                        event a success. We look forward to future
                        collaborations.”
                      </p>
                    </blockquote>
                  </div>
              ...
              <div data-aos="zoom-in" data-aos-delay="200" data-aos-duration="1000" className="flex flex-col overflow-hidden shadow-xl">
                <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                  <div className="flex-1">
                    ...
                    <blockquote className="flex-1 my-5">
                      <p className="text-lg leading-relaxed text-gray-900">
                        “TaskFlow consistently amazes us.
                        Their creativity and flawless execution make them our
                        go-to for corporate events.”
                      </p>
                    </blockquote>
                  </div>
                  <p className="text-base font-bold text-gray-900">
              ...
              <div data-aos="flip-right" data-aos-delay="300" data-aos-duration="1000" className="flex flex-col overflow-hidden shadow-xl">
                <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                  <div className="flex-1">
                    ...
                    <blockquote className="flex-1 my-5">
                      <p className="text-lg leading-relaxed text-gray-900">
                        “Attending a TaskFlow event was
                        impressive. Their professionalism and guest-centric
                        approach created a memorable experience. Highly
                        recommended!”
                      </p>
                    </blockquote>
                  </div>
